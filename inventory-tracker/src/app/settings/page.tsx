  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">Product Data</h2>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">Fee Settings</h2>
          ...
          <div className="space-y-2">
            {KASHEESH_FEE_OPTIONS.map(option => (
              <div className="flex items-center" key={option.value.toString()}>
                ...
                />
                <label htmlFor={`kasheesh-${option.value}`} className="ml-3 text-sm text-gray-700">
                  {option.label}
                </label>
              </div>
            ))}
            ...
            {PURE_FEE_OPTIONS.map(option => (
              <div className="flex items-center" key={option.value.toString()}>
                <input
                  ...
                  className="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                />
                <label htmlFor={`pure-${option.value}`} className="ml-3 text-sm text-gray-700">
                  {option.label}
                </label>
              </div>
            ))}
